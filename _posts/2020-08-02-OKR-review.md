...
- 중요도/긴급성 매트릭스 (important/urgent matrix) = 아이젠하워 박스
  ![image](https://advisoryalliance.com/wp-content/uploads/2020/03/7_habits_decision-making_matrix.png){: width="70%"}{: .center}
...
- OKR로 목표를 정하고, 주간 우선 순위 목록으로 그 일들을 실행하고 있는지 계속 기억할 수 있다.
    ...
    - 그런 의미?에서 매주 월요일에 다 함께 우선순위들을 정하고 한 주를 시작하기 (weekly check-in)
        ...
        ![image](https://miro.medium.com/max/1200/1*MtLRz6oaRnuBV7rQn2GIoQ.png){: width="70%"}{: .center}
...
<iframe src=' [https://youtu.be/L4N1q4RNi9I](https://youtu.be/L4N1q4RNi9I)' frameborder='0' allowfullscreen></iframe>
